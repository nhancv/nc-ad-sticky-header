...
public class StyleKeepActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_style_keep);
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Style Keep Header");
        }

        RecyclerView rvListItems = (RecyclerView) findViewById(R.id.rvListItems);
        final StyleKeepAdapter adapter = new StyleKeepAdapter();
