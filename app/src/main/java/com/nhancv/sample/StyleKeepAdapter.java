...
public class StyleKeepAdapter extends RecyclerView.Adapter<StyleKeepAdapter.ContentViewHolder> implements Filterable, StickyHeaderAdapter<StyleKeepAdapter.HeaderHolder> {
    ...
    @Override
    public StyleKeepAdapter.ContentViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(StyleKeepAdapter.ContentViewHolder holder, int position) {
