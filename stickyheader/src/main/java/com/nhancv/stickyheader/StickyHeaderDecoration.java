package com.nhancv.stickyheader;
...
public class StickyHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    private boolean keepHeader; //option for keep header session

    /**
     * @param adapter the sticky header adapter to use with default is keep header
     */
     ...
     */
    public StickyHeaderDecoration(StickyHeaderAdapter adapter, boolean keepHeader) {
